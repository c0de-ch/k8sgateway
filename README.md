...
**Video version** (pause, scrub, change the playback speed): [docs/images/auth-flow.mp4](docs/images/auth-flow.mp4)
...
**Video version** (pause, scrub, change the playback speed): [docs/images/login-flow-k8s.mp4](docs/images/login-flow-k8s.mp4) - GitHub plays it in the file view; the left column lists the operations (black = pending, highlighted = in progress, green = done).
