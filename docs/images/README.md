...
| [`auth-flow.mp4`](auth-flow.mp4) | The same animation as an H.264 video (16 fps). |
...
| [`login-flow-k8s.mp4`](login-flow-k8s.mp4) | The same animation as an H.264 video (16 fps): pause, scrub, change the speed. GitHub plays it in the file view. |
